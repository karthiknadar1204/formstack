...
// const PROMPT = "on the basis of the Description,please give form in JSON format with form title,form subheading,form field,form name,placeholder name and form Label,fieldType,field required and form label in JSON format.";
